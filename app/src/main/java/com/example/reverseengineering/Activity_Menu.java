...
public class Activity_Menu extends AppCompatActivity {
    ...
    private void findViews() {
        ...
        if (menu_BTN_start == null)
            Log.e("Activity_Menu", "menu_BTN_start is NULL!");

        if (menu_EDT_id == null)
            Log.e("Activity_Menu", "menu_EDT_id is NULL!");
    }
    ...
    public void startGame(String id, String data) {
        try {
            ...
            int index = Integer.parseInt(String.valueOf(id.charAt(7)));
